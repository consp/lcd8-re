...
void uart_init(uint32_t baud)
{
    ...
    uart_rx_start = uart_rx_buffer;
    uart_rx_end = uart_rx_buffer;
...
CRITICAL void DMA1_Channel4_IRQHandler(void)
{
...
CRITICAL void DMA1_Channel5_IRQHandler(void)
{
...
#if LV_USE_LOG && !defined(SEMIHOSTING) && !defined(SEGGER_RTT)
#if LVGL_VERSION_MAJOR == 9
void lv_log_callback(lv_log_level_t lvl, const char *c) {
#else
void lv_log_callback(const char *c) {
