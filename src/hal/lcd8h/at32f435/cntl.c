...
static void adc_config(void) {
    ...
    adc_ordinary_channel_set(ADC1, ADC_CHANNEL_16, 1, ADC_SAMPLETIME_247_5);
    adc_ordinary_channel_set(ADC1, ADC_CHANNEL_17, 2, ADC_SAMPLETIME_247_5);
    adc_ordinary_channel_set(ADC1, VOLTAGE_DETECT_ADC_CH, 3, ADC_SAMPLETIME_247_5);
    adc_ordinary_channel_set(ADC1, EXT_TEMP_ADC_CH, 4, ADC_SAMPLETIME_247_5);
    adc_ordinary_channel_set(ADC1, NC_BUTTON_ADC_CH, 5, ADC_SAMPLETIME_247_5);
    adc_ordinary_channel_set(ADC1, POWER_BUTTON_ADC_CH, 6, ADC_SAMPLETIME_247_5);
    ...
    /* adc_ordinary_conversion_trigger_set(ADC1, ADC123_ORDINARY_TRIG_SOFTWARE, TRUE); */
...
static void tmr_config(void) {
    ...
    /* tmr_channel_value_set(TMR14, TMR_SELECT_CHANNEL_1, 1000); */
...
void controls_init(void) {
    ...
    gpio_initstructure.gpio_drive_strength = GPIO_DRIVE_STRENGTH_STRONGER; // input
...
static inline int power_button_measure(void) {
    ...
    return adc.power_button >= 3*1024;
}
