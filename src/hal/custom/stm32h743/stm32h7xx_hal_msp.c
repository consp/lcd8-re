...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* hadc)
{
  if(hadc->Instance==ADC1)
  {
    ...
    PA6     ------> ADC1_INP3
    */
    HAL_GPIO_DeInit(GPIOA, ADC_VBUS_Pin|ADC_PHOTO_Pin);
  ...
  else if(hadc->Instance==ADC2)
  {
    ...
    PB0     ------> ADC2_INP9
    */
    HAL_GPIO_DeInit(BTN_UP_GPIO_Port, BTN_UP_Pin);
...
void HAL_UART_MspDeInit(UART_HandleTypeDef* huart)
{
  ...
  else if(huart->Instance==USART2)
  {
    ...
    PA3     ------> USART2_RX
    */
    HAL_GPIO_DeInit(GPIOA, USART_BT_TX_Pin|USART_BT_RX_Pin);
...
static void HAL_FMC_MspDeInit(void){
  ...
  */
  ...
  HAL_GPIO_DeInit(GPIOD, LCD_D13_Pin|LCD_D14_Pin|LCD_D15_Pin|LCD_CD_Pin
                          |LCD_D0_Pin|LCD_D1_Pin|LCD_D2_Pin|LCD_D3_Pin
                          |LCD_RD_Pin|LCD_WR_Pin);

  HAL_GPIO_DeInit(LCD_CS_FCM_GPIO_Port, LCD_CS_FCM_Pin);
