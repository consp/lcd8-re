...
/**
  ...
  */
inline uint16_t gpio_input_data_read(gpio_type *gpio_x)
{
...
/**
  ...
  * @retval none
  */
inline void gpio_bits_set(gpio_type *gpio_x, uint16_t pins)
{
  gpio_x->scr = pins;
}
...
/**
  ...
  * @retval none
  */
inline void gpio_bits_reset(gpio_type *gpio_x, uint16_t pins)
{
  gpio_x->clr = pins;
}
...
/**
  ...
  * @retval none
  */
inline void gpio_bits_write(gpio_type *gpio_x, uint16_t pins, confirm_state bit_state)
{
  if(bit_state != FALSE)
  {
    gpio_x->scr = pins;
